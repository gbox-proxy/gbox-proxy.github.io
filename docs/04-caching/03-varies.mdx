...
To set varies a certain query result should be cached by, create a cache rule for the types you want to cache separately per-user (see Cache [Rules](./02-rules.mdx) for more information):
